# X-CASH Proof of Stake - Delegates Website Server

This is the server for the [X-CASH Proof of Stake - Delegates Website](https://github.com/X-CASH-official/XCASH_proof_of_stake_delegates_website)
...
`$ git clone https://github.com/X-CASH-official/XCASH_proof_of_stake_delegates_website_server.git`



### Build instructions

X-CASH Proof of Stake - Delegates Website Server uses a Make file.

After cloning the repository, navigate to the folder  
`cd XCASH_proof_of_stake_delegates_website_server`
...
## Running X-CASH Proof of Stake - Delegates Website Server test
It is recomeneded to run the X-CASH Proof of Stake - Delegates Website Server test before you run the main program. The test will ensure that your system is compatbile, and that you have setup your system correctly.

To run the X-CASH Proof of Stake - Delegates Website Server test, Navigate to the folder that contains the binary, then run  
`./xcash_proof_of_stake_delegates_website_server --test`
